...
#ifndef UDP_IOMUST_CLIENT_H
#define UDP_IOMUST_CLIENT_H
...
/**
 * \ingroup udpiomust
 * \brief A Udp Iomust client
 *
 * Every packet sent should be returned by the server and received here.
 */
class UdpIomustClient : public Application 
{
public:
  /**
   ...
   * care) by this call.
   *
   * \warning If you have set the fill data for the iomust client using one of the
   ...
   * \param dataSize The desired size of the resulting packet data.
   */
   ...
   * \param dataSize The desired size of the final data.
   */
