 ...
 */
class UdpBroadcastServerHelper
{
public:
  /**
   * Create UdpBroadcastServerHelper which will make life easier for people trying
   * to set up simulations with iomust devices.
   *
   * \param port The port the server will wait on for incoming packets
   */
  UdpBroadcastServerHelper (uint16_t port);
  ...
  /**
   * Create a UdpBroadcastServerApplication on the specified Node.
   *
  ...
  /**
   * Create a UdpBroadcastServerApplication on specified node
   *
   ...
   *
   * Create one udp Broadcast server application on each of the Nodes in the
   * NodeContainer.
   *
...
private:
  /**
   * Install an ns3::UdpBroadcastServer on the node configured with all the
   * attributes set with SetAttribute.
   *
   * \param node The node on which an UdpBroadcastServer will be installed.
...
public:
   ...
   * \param port The port the server will wait on for incoming packets
   */
  UdpMixMecServerHelper (uint16_t port);
